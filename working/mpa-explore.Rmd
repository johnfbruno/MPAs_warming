...
dest <- "../data/ne110.zip" # zip file destination

download.file(url = url, destfile = dest, method = "auto") # download from web

unzip(dest, exdir = "../data") # unzip

list.files("../data") # check unzip

rm("dest", "url") # clean up workspace
```
