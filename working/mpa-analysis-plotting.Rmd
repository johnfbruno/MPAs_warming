...
p.wld <- gplot(cmip) + 
  ...
  guides(fill = guide_colorbar(title = expression(paste(degree, C,"/year")), barheight = 10, raster = TRUE)) +   theme(legend.title = element_text(size = 10), plot.title = element_text(size = 20, hjust = 0)) +
  labs(title = "a") +
  xlab("") +
  ylab("") +
