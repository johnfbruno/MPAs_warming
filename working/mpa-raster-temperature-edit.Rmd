...
Exporting the masked and extracted rasters and checking these alongside MPA points in QGIS shows all cells containing MPAs to be captured. 
...
In summary, the code needed to removes land surface temperatures from the CMIP5 surface temperature rasters is as follows:

Requires land surface and CMIP5 datasets.
